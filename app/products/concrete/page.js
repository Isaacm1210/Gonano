...
export default function Concrete() {
    return <div className="sm:pt-24">
            <section id="Heading" className="min-h-96 bg-[url(/products/surface/Concrete.jpg)] bg-cover -mt-24 border-b-4 border-purple-gradient">
                <div className="w-full min-h-96  bg-linear-to-r from-midnight-blue via-midnight-blue/90 to-midnight-blue/40 pt-24">
                    <div className="p-20 mb-20">
                        <h1 className="text-6xl font-bold mb-4">Concrete Sealants</h1>
                        <h2 className="text-xl ml-20">Total Protection For Your Concrete Surfaces</h2>
                    </div>
            ...
            <section className="p-20 bg-offWhite text-black text-center border-b-4 border-purple-gradient">
                <h1 className="text-6xl font-bold">Protection with GoNano&apos;s Concrete Sealer</h1>
            ...
            <section className="flex justify-evenly p-20">
                ...
                <div className="w-1/3 m-auto">
                    <h3 className="text-4xl font-semibold">Our penetrating nanoparticle solution provides the best concrete sealing finish</h3>
            ...
            <section className="bg-offWhite p-20">
                ...
                <div className="mt-10 text-black text-center">
                    <h1 className="text-6xl font-bold">10 years.</h1>
